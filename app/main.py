...
def safe_ping(host: str):
    try:
        if ' ' in host or '	' in host or '\' in host or ';' in host or '&' in host or '>' in host or '<' in host or '|' in host or '*' in host or '?' in host or '~' in host or '`' in host or '$' in host or '%' in host or '^' in host or '(' in host or ')' in host or '[' in host or ']' in host:
